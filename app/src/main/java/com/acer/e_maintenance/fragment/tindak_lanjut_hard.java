...
public class tindak_lanjut_hard extends Fragment implements View.OnClickListener{
    RecyclerView recyle_tindak;
    private List<Item_tindak_hard> list_hard_kom = new ArrayList<>();
    private adapter_list_tindak_hard mAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.activity_tindak_lanjut_hard, container, false);
        ...
        recyle_tindak = (RecyclerView) v.findViewById(R.id.recyle_tindak_hard);
        mAdapter = new adapter_list_tindak_hard((ArrayList<Item_tindak_hard>) list_hard_kom);
        ...
        tgl_tindak = (EditText) v.findViewById(R.id.tgl_tindak);
    ...
    private void loadData() {
            ...
            JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.GET,
                    config.LIST_TINDAK_HARD + tgl_tindak.getText().toString() + "&id_asisten="
                ...
                public void onResponse(JSONObject response) {
                    ...
                    try {
                        ...
                        for (int i = 0; i < episodes.length(); i++) {
                            ...
                            String id_kom = episode.getString(config.KEY_ID_KOM_TINDAK);
                            String nama_kom = episode.getString(config.KEY_NAMA_KOMPONEN);
                            String ket_tindak = episode.getString(config.KEY_KET_TINDAK);
                            String ket = episode.getString(config.KEY_KET);
                            Item_tindak_hard lostItem = new Item_tindak_hard(
